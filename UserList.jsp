...
<html>
    <head>
        ...
        <%
            ...
            {
                String upQry="update tbn_user set user_status='1' where user_id='"+request.getParameter("aid")+"'";
    ...
    <body>
        <h3><u><center>USER LIST</center></u></h3>
        <table border="1" align="center">
            ...
            <%
                ...
                String selQry = "select * from tbn_user u inner join tbn_place p on u.place_id=p.place_id inner join tbn_district d on p.district_id=d.district_id where user_status=0";
